...
import cn.gxnu.service.imp.SPnametrafficsService;
...
@WebServlet("/spnametraffics")
public class SPnametrafficsController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String b=req.getParameter("b");
        String e=req.getParameter("e");

        SPnametrafficsService spnametrafficsService=new SPnametrafficsService();
        List<SPnametraffics> listStraffics = new ArrayList<SPnametraffics>();
        if(e!=null && !equals("")&&!equals("null")){
            listStraffics =spnametrafficsService.FindA(b,e);//查询某个时间段
        }else
        {
            listStraffics =spnametrafficsService.FindB(b);//查询某天
        }
